...
num_reads = int(str(df_STARLog.loc['                   Uniquely mapped reads number |', 1])) + \
            int(str(df_STARLog.loc['        Number of reads mapped to multiple loci |', 1]))
...
df_cov.to_csv(f_output, index=False, sep='\t')